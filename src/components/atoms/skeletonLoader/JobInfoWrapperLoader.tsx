...
const JobInfoWrapperLoader = () => {
  return (
    <div className="grid grid-cols-12 gap-6 pb-10">
      ...
      <div className="lg:col-span-9 col-span-12 flex flex-col w-full bg-white rounded-lg py-6">
        <div className="sm:px-10 px-4 space-y-2 border-b pb-6">
          <Skeleton className="h-6 w-40 rounded-lg bg-gray-300" />
          <Skeleton className="h-6 max-w-md w-full rounded-lg bg-gray-300" />
        </div>
        ...
        <div className="sm:px-10 px-4 py-6 flex flex-wrap gap-4">
          <Skeleton className="w-28 h-28 max-sm:w-20 max-sm:h-20 rounded-lg bg-gray-300" />
        </div>
      </div>
...
export default JobInfoWrapperLoader;
